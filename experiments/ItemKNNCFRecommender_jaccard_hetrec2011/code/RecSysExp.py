...
dataset_kwargs['header'] = True
dataset_kwargs['min_ratings_user'] = 2
#dataset_kwargs['min_ratings_item'] = 5

URM_suffixes = ['_URM_train.npz', '_URM_test.npz', '_URM_validation.npz', '_URM_train_small.npz', '_URM_early_stop.npz']
all_datasets = [Yelp2015, 'hetrec2011', '1M', LastFM]
...
all_recommenders = ['TopPop', 'Random', 'PureSVD', 'ALS', 'BPR', 'SLIMBPR', 'SLIMELASTIC', 'CFGAN', 'GANMF', 'DisGANMF',
                    'DeepGANMF', 'fullGANMF', 'ItemKNN', 'P3Alpha', 'EASER', 'CAAE']
...
def main(arguments):
    ...
    dict_rec_classes['P3Alpha'] = P3alphaRecommender
    dict_rec_classes['EASER'] = EASE_R_Recommender
    dict_rec_classes['CAAE'] = CAAE
    ...
    dict_dimensions['P3Alpha'] = p3alpha_dimensions
    dict_dimensions['EASER'] = easer_dimensions
    dict_dimensions['CAAE'] = caae_dimensions
