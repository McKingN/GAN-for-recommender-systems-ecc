...
all_recommenders = ['TopPop', 'Random', 'PureSVD', 'ALS', 'BPR', 'SLIMBPR', 'SLIMELASTIC', 'CFGAN', 'GANMF', 'DisGANMF',
                    'DeepGANMF', 'fullGANMF', 'ItemKNN', 'P3Alpha', 'EASER']
...
def main(arguments):
    ...
    p3alpha_fit_params = [d.name for d in p3alpha_dimensions]
    ...
    easer_fit_params = [d.name for d in easer_dimensions]
    ...
    dict_fit_params['P3Alpha'] = p3alpha_fit_params
    dict_fit_params['EASER'] = easer_fit_params
